...
class TestWorkflowClientGetWorkflowInstance:
    ...
    def test_get_workflow_instance_success(self, mock_session_manager):
        ...
        responses.add(
            responses.GET,
            "https://api.test.com/compute/workflows/instances/wf-instance-123",
    ...
    def test_get_workflow_instance_includes_auth_header(self, mock_session_manager):
        ...
        responses.add(
            responses.GET,
            "https://api.test.com/compute/workflows/instances/wf-123",
    ...
    def test_get_workflow_instance_raises_on_http_error(self, mock_session_manager):
        ...
        responses.add(
            responses.GET, "https://api.test.com/compute/workflows/instances/wf-123", json={"error": "Not found"}, status=404
        )
    ...
    def test_get_workflow_instance_raises_on_invalid_json(self, mock_session_manager):
        ...
        responses.add(responses.GET, "https://api.test.com/compute/workflows/instances/wf-123", body="not json", status=200)
...
class TestWorkflowClientRetryBehavior:
    ...
    def test_get_workflow_instance_retries_on_401(self, mock_session_manager):
        ...
        responses.add(
            responses.GET, "https://api.test.com/compute/workflows/instances/wf-123", json={"error": "Unauthorized"}, status=401
        )
    ...
    def test_get_workflow_instance_retries_on_403(self, mock_session_manager):
        ...
        responses.add(
            responses.GET, "https://api.test.com/compute/workflows/instances/wf-123", json={"error": "Forbidden"}, status=403
        )
        # Second call succeeds
        responses.add(
            responses.GET,
